...
/*
define('DNS','mysql:host=192.168.20.19:3306;dbname=DAW205DBProyectoTema5); // Direccion del host y nombre de la base de datos para la conexion con la base de datos
define('USER','usuarioDAW205DBProyectoTema5'); // Usuario administrador de la bsae de datos DAW217DBProyectoTema5
